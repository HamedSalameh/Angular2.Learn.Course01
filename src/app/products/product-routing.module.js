...
var ProductModuleRouting = (function () {
    function ProductModuleRouting() {
    }
    return ProductModuleRouting;
}());
ProductModuleRouting = __decorate([
    core_1.NgModule({
        declarations: [],
        imports: [
...
exports.ProductModuleRouting = ProductModuleRouting;
;
